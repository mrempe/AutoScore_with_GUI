...
7) Make one excel spreadsheet when autoscoring several files in one directory.  It should have the filenames, kappa, and global agreement and data source info tab. 
8) Find Jon Brenneke's txt2edf function.  May be .m or .py.  on UltraRoss or TDT3 system.  
